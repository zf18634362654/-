...
<td><a href="deleteOneCourseBySno?sno=<%=request.getParameter("sno") %>&cno=<%=course.getCno() %>">删除</a></td>>
...
<a href="deleteCourseBysnoServlet?sno=<%=request.getParameter("sno") %>">删除所有选修内容 </a><br/>
